            ...
            <div className="w-full flex flex-col gap-5">
                {
                    data.repositories.map((item, index) => {
                        return <Link href={item[4]} className="flex flex-col lg:flex-row gap-5 lg:gap-0 items-center justify-around rounded-lg shadow-lg hover:shadow-2xl w-full py-8" key={index}>
