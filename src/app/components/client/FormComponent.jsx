...
import { CheckIcon, ChevronRightIcon, ReloadIcon } from '@radix-ui/react-icons'
...
const FormComponent = () => {
	...
	return (
		<form className="flex flex-col gap-5 justify-center items-center w-full" onSubmit={handleSubmit(onSubmit)}>
			...
			{
				loading ? <Button disabled className="w-full group">
